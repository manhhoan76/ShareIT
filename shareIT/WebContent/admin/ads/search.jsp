	  ...
	  %>
          ...
          <div class="pagination" style="margin-left: 23px;   margin-top: -31px;">           
			...
			<%
				...
				String urlSEOFirst = request.getContextPath()+"/admin/ads/search?page=1&key="+key;
				String urlSEOLast = request.getContextPath()+"/admin/ads/search?page="+sumPage+"&key="+key;
				String urlSEOPre = request.getContextPath()+"/admin/ads/search?page="+pre+"&key="+key;
				String urlSEONext = request.getContextPath()+"/admin/ads/search?page="+next+"&key="+key;
				%>
				...
				if (sumPage <4) {
					for (int i=1; i<=sumPage;i++){
						...
						String urlSEO = request.getContextPath()+"/admin/ads/search?page="+i+"&key="+key;
						if (i==1){
							%>	
