...
<%@include file="/templates/admin/inc/sidebar.jsp" %>
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-table"></i><a href="<%=request.getContextPath()%>/admin/news/index">Tin tức</a></li>
                           ...
                           <%
                           		if(request.getAttribute("key") !=null){
                        			String key = (String) request.getAttribute("key");
                           			%>
                            <input class="form-control" placeholder="Search" type="text" name="key" value="<%=key%>">
                            <%}else{  %>
      ...
      <div class="pagination" style="margin-left: 23px;   margin-top: -31px;">           
			...
			<%
				...
				String urlSEOFirst = request.getContextPath()+"/admin/news/search?page=1&key="+key+"&catID="+catID;
				String urlSEOLast = request.getContextPath()+"/admin/news/search?page="+sumPage+"&key="+key+"&catID="+catID;
				String urlSEOPre = request.getContextPath()+"/admin/news/search?page="+pre+"&key="+key+"&catID="+catID;
				String urlSEONext = request.getContextPath()+"/admin/news/search?page="+next+"&key="+key+"&catID="+catID;
				%>
				...
				if (sumPage <4) {
					for (int i=1; i<=sumPage;i++){
						...
						String urlSEO = request.getContextPath()+"/admin/news/search?page="+i+"&key="+key+"&catID="+catID;
						if (i==1){
							%>	
