	  ...
	  %>
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td><a href="<%=request.getContextPath()%>/public/detail?nid=<%=objComment.getId()%>"><%=objComment.getName_news() %></a></td>
          ...
          <div class="pagination" style="margin-left: 23px;   margin-top: -31px;">           
			...
			<%
				...
				String urlSEOFirst = request.getContextPath()+"/admin/comment/search?page=1&key="+key;
				String urlSEOLast = request.getContextPath()+"/admin/comment/search?page="+sumPage+"&key="+key;
				String urlSEOPre = request.getContextPath()+"/admin/comment/search?page="+pre+"&key="+key;
				String urlSEONext = request.getContextPath()+"/admin/comment/search?page="+next+"&key="+key;
				%>
				...
				if (sumPage <4) {
					for (int i=1; i<=sumPage;i++){
						...
						String urlSEO = request.getContextPath()+"/admin/comment/search?page="+i+"&key="+key;
						if (i==1){
							%>	
