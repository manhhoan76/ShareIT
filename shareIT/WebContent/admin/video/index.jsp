	  ...
	  %>
          ...
          <div class="pagination" style="margin-left: 23px;   margin-top: -31px;">           
			...
			<%
				...
				String urlSEOFirst = request.getContextPath()+"/admin/video?page=1";
				String urlSEOLast = request.getContextPath()+"/admin/video?page="+sumPage;
				String urlSEOPre = request.getContextPath()+"/admin/video?page="+pre;
				String urlSEONext = request.getContextPath()+"/admin/video?page="+next;
				%>
				...
				if (sumPage <4) {
					for (int i=1; i<=sumPage;i++){
						...
						String urlSEO = request.getContextPath()+"/admin/video?page="+i;
						if (i==1){
							%>	
				...
				for (int i=current_page; i<=current_page+3;i++){
					...
					String urlSEO = request.getContextPath()+"/admin/video?page="+i;if (i==1){
						%>	
						<a <%=active %> style=" text-align: center;" href="<%=urlSEO%>"><%=i %></a>
						<%} else {%>
						<a <%=active %> style=" text-align: center;" href="<%=urlSEO%>">|<%=i %></a>
