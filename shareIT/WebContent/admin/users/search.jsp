		...
		<% }}}} %>
           ...
           <div class="pagination" style="margin-left: 23px;   margin-top: -15px;">           
			...
			<%
				...
				String urlSEOFirst = request.getContextPath()+"/admin/users/search?page=1&key="+key;
				String urlSEOLast = request.getContextPath()+"/admin/users/search?page="+sumPage+"&key="+key;
				String urlSEOPre = request.getContextPath()+"/admin/users/search?page="+pre+"&key="+key;
				String urlSEONext = request.getContextPath()+"/admin/users/search?page="+next+"&key="+key;
				%>
				...
				if (sumPage <4) {
					for (int i=1; i<=sumPage;i++){
						...
						String urlSEO = request.getContextPath()+"/admin/users/search?page="+i+"&key="+key;
						if (i==1){
							%>	
