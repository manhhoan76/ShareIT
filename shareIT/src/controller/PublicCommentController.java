...
public class PublicCommentController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Comment objComment = new Comment(0, content, null, 0, idNew, null, name, email, website, 0);
		PrintWriter out = response.getWriter();
		CommentDAO commentDAO = new CommentDAO();
		System.out.println(name+"--"+email+"--"+website+"--"+content+"--"+idNew);
		if (commentDAO.addCommentParent(objComment) >0) {
