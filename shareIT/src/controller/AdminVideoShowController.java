 ...
 */
public class AdminVideoShowController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminVideoShowController() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (objVideo != null) {
			out.println("<iframe style='margin-left: 290px;' width='670' height='377' src='"+objVideo.getLink()+"' frameborder='0' allowfullscreen></iframe>");
		} else {
