 ...
 */
public class PublicCommentVideoReplyShowController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PublicCommentVideoReplyShowController() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(idNew+"--"+idComment+"--"+idParentComment);
		PrintWriter out = response.getWriter();
			out.println("<div class='contact-content'>"+
                                 	...
                                 	+"<input class='field' type='text' name='' id='name_reply' placeholder='Your Name' >"
                                        ...
                                        +"<button  class='btn btn-icon submit' type='submit'><span class='icon'></span><a href='javascript:void(0)' onclick='replyVideo("+idComment+","+idNew+","+idParentComment+")' style='color: white;'>Reply</a></button>"
                                        +"</form>"
