...
public class AdminContactIndexController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int sumPage = (int)Math.ceil((float)sumContact/Define.ROW_COUNT_ADMIN); // code trong do post sao chay dc e? // phai doGet chu, ko thi doGet phai goi doPost 
		...
		ArrayList<Contact> listContact = contactDAO.getItemsPagination(offset, Define.ROW_COUNT_ADMIN);
