 ...
 */
public class AdminCommentVideoSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminCommentVideoSearchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int sumComment = commentDAO.countcommentvideoByKey(key);
		...
		ArrayList<CommentVideo> listComment = commentDAO.getItemsPaginationByKey(key,offset, Define.ROW_COUNT_ADMIN);
