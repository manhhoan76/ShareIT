 ...
 */
public class AdminUsersSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminUsersSearchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int sumUser = usersDAO.countUserByKey(key);
		...
		ArrayList<Users> listUsers = usersDAO.getItemsPaginationByKey(key,offset, Define.ROW_COUNT_ADMIN);
