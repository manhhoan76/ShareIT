 ...
 */
public class AdminAdsIndexController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminAdsIndexController() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (AuthUtil.checkUser(request) == false) {
			...
			ArrayList<Ads> listAds = adsDAO.getItemsPagination(offset, Define.ROW_COUNT_ADMIN);
			System.out.println(listAds.get(1).getLink());
